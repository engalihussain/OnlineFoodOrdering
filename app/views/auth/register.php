        ...
        <form class="mt-8 space-y-6" action="index.php?action=register" method="POST">
            <div class="rounded-md shadow-sm space-y-4">
                <div>
                    ...
                    <input id="name" name="name" type="text" required class="appearance-none relative block w-full px-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-orange-500 focus:border-orange-500 focus:z-10 sm:text-sm" placeholder="Full Name">
                </div>
                <div>
            ...
            <div class="flex items-center justify-between">
                <div class="text-sm">
                    <a href="index.php?action=login" class="font-medium text-orange-600 hover:text-orange-500">
